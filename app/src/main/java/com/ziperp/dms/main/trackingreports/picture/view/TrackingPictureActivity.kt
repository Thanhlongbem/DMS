...
class TrackingPictureActivity: BaseActivity() {
    private lateinit var scrollListener: RecyclerViewLoadMoreScroll
    private var filterDialog: FilterDialogFragment? = null
    lateinit var adapter: TrackingPictureAdapter
    ...
    override fun initView() {
        setToolbar(R.string.str_tracking_picture.getString(), true)
        initSearchBox()
        initRecyclerView()
        dataObserver()
        viewModel.getTrackingPictureList()
    }
    ...
    private fun initRecyclerView() {
        ...
        adapter = TrackingPictureAdapter()
        adapter.onClickListener = {
            val visitCustomer = adapter.data[it]
            val intent = Intent(this, TrackingPictureDetailActivity::class.java)
        ...
        swipe_refresh.setOnRefreshListener {
            viewModel.pagingParam.clear()
            viewModel.getTrackingPictureList(false)
        }
    }
    ...
    private fun showFilterDialog() {
        val data = viewModel.latestItemControls ?: FormDataFactory.get(Form.FORM_ID_TRACKING_PICTURE)
